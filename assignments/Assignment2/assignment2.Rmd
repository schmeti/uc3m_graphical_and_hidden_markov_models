...
We begin by designing a graphical model based on what variables we asssume to be dependent. We begin by assuming that:
...
Next, we fit the model using the data and print out the probablity tables of the resulting model.
