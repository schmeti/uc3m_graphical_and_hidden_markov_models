...
and use that combination to perform a out of sample prediction for injury, yielding the following probability: 

```{r}
# predict 
cpquery(model_fit, (injury=="0"), (sex=="f" & agegrp3=="60+" & yrs_experience=="little" & train_warm  =="1"),n=1000000) # I am not sure what we are predicting, like that is the probability of what(?)
```
...
# [sex][yrs_experience|sex][injury|sex][coached|sex][agegrp3|coached][train_warm|coached] 
# INITIAL IDEA:
# [sex][agegrp3][yrs_experience|sex][train_warm|sex:yrs_experience:agegrp3][coached|sex:agegrp3][injury|train_warm:sex:coached]
```
...
# [sex][agegrp3][yrs_experience|sex][coached|sex:agegrp3][train_warm|coached][injury|sex:train_warm] 
