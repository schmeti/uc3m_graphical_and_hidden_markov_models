...
```{r}
# Define full model
model_formular_full <- ~well_versed_with_the_subject*solves_doubts_willingly*explains_concepts_in_an_understandable_way*structuring_of_the_course*degree_of_difficulty_of_assignments*use_of_presentations

# Define reduced model
model_formular_reduced  <- ~ well_versed_with_the_subject * balanced_diet +
