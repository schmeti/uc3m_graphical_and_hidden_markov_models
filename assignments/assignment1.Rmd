...
m_full_selection = dmod(~.^.,data=xtab_result)
mbaic <- backward(m_full_selection,k=log(sum(xtab_result)))
plot(mbaic)


m_zero_selection = dmod(~.^1,data=xtab_result)
mfaic <- forward(m_zero_selection,k=log(sum(xtab_result)))
plot(mfaic)
```
...
m_full_selection = dmod(~.^.,data=xtab_result)
mbaic <- backward(m_full_selection,type="unrestricted")
plot(mbaic)


m_zero_selection = dmod(~.^1,data=xtab_result)
mfaic <- forward(m_zero_selection,type="unrestricted")
plot(mfaic)
```
...
m_full_selection = dmod(~.^.,data=xtab_result)
mbaic <- backward(m_full_selection,type="unrestricted",k=log(sum(xtab_result)))
plot(mbaic)


m_zero_selection = dmod(~.^1,data=xtab_result)
mfaic <- forward(m_zero_selection,type="unrestricted",k=log(sum(xtab_result)))
plot(mfaic)
```
